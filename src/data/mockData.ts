...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  },
  {
    id: 'yousaf-piryani',
    name: 'Yousaf Piryani',
    role: 'AI Engineer (Neural Networks & Deep Learning)',
    description: '30 years experience in neural networks, deep learning architectures, and complex enterprise AI deployments. US-returned.',
    image: null,
    accent: 'gold',
  },
  {
