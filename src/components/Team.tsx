    ...
    <section className="w-full px-4 sm:px-6 lg:px-8 py-20 lg:py-28 relative" id="team">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 sm:mb-20">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full glass-2 border-[#10B981]/30 text-xs uppercase text-[#10B981] tracking-widest font-semibold font-mono-code mb-3.5">
        ...
        <div className="mb-14 rounded-3xl glass-2 holographic-edge p-6 sm:p-8 lg:p-10 spatial-card shadow-[0_24px_70px_rgba(0,0,0,0.85)] max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            {/* Founder Photo */}
            <div className="md:col-span-4 flex flex-col items-center text-center">
              <div className="relative w-44 h-44 sm:w-52 sm:h-52 rounded-3xl overflow-hidden shadow-2xl border-2 border-[#F5C761]/40 bg-[#050A14] glow-gold-jewel group">
                <img
              ...
              <div className="mt-3.5 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#10B981]/15 border border-[#10B981]/30 text-[#6EE7B7] text-[11px] font-mono-code font-semibold">
              ...
              >
                ...
                <div className="relative aspect-[4/5] w-full overflow-hidden bg-[#050B18]">
                  {member.image ? (
                    ...
                    >
                      ...
                      >
                        <User className="w-9 h-9 sm:w-11 sm:h-11 opacity-50" style={{ color: accent.color }} />
                      </div>
                    </div>
                  )}
                ...
                <div className="p-4 sm:p-5 pt-3 flex flex-col justify-between flex-1">
                  ...
                  <div className="mt-4 pt-3 border-t border-white/[0.06] flex items-center justify-between text-[11px] font-mono-code text-[var(--text-muted)]">
                    <span>Direct Access</span>
                    <span style={{ color: accent.color }}>Engineering Team</span>
                  </div>
                </div>
              </div>
            );
